...
#Rolling Window NOT WORKING (MLP Model not producting phis and thetas)
Rolling_Window_ASE(Post_Vaccine$new_deaths_per_million, trainingSize = 70, horizon = 6, d = 0, phi = Vacc_fit.mlp1$, theta = Vacc_fit.mlp1$,s= 0) 
