...
ltest$pval
M1_final_res=aic.wge(fit1i$residuals,p=0:10, q=0)
...
preds1 = predict(fit1, newxreg = cbind(Post_Vaccine$new_cases_per_million[83:96], Post_Vaccine$icu_patients_per_million[83:96],Post_Vaccine$hosp_patients_per_million[83:96], Post_Vaccine$new_vaccinations_smoothed_per_million[91:96]))

ASE1_short = mean((Post_Vaccine$new_deaths_per_million[91:96] - preds1$pred)^2)
ASE1_short #2.076967

# Pred for past 40 days
preds_1 = predict(fit1, newxreg = cbind(Post_Vaccine$new_cases_per_million[57:96], Post_Vaccine$icu_patients_per_million[57:96],Post_Vaccine$hosp_patients_per_million[57:96], Post_Vaccine$new_vaccinations_smoothed_per_million[57:96]))
