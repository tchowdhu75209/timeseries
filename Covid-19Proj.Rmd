...
#Not white noise, Autocorrelation are correlated. Damped sinusoidal indicating seasonality
...
#aic5.wge(pv_s7, p=0:13, q=0:3) #Pick p=7, q=3
#Check bic
...
plot(as.numeric(Post_Vaccine$new_deaths_per_million), type = "l", xlim = c(1,101))
...
aic.wge(mv_fit1$residuals, p=0:8,q=0) #AIC picks 8,0 ; aic =0.8019881
...
ASE_mv0   #1.896324
plot(as.numeric(Post_Vaccine$new_deaths_per_million), type = "l", xlim = c(1,96), ylab = "new_deaths_per_million", main = "Next 10 day new_deaths_per_million Forecast")
...
fore.mlp2_14 = forecast(fit.mlp2_16, h = 14, xreg = PV_DF_fore1)
plot(fore.mlp2_14)
