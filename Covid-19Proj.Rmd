...
fit2_m1=arima(Post_Vaccine2$new_deaths_per_million,order=c(9,0,0),xreg=expvar_vaccine2)
fit2_m1
AIC(fit2_m1) #312.61
...
fit2_m2=arima(Post_Vaccine2$new_deaths_per_million,order=c(9,0,0),xreg=expvar_vaccine2)
fit2_m2
AIC(fit2_m2) #312.6069, not much of a change from previous trend


preds2 = predict(fit2_m2, newxreg = cbind(Post_Vaccine2$new_cases_per_million[92:96], Post_Vaccine2$icu_patients_per_million[92:96],Post_Vaccine2$hosp_patients_per_million[92:96], Post_Vaccine2$new_vaccinations_smoothed_per_million[92:96]))
ASE2 = mean((Post_Vaccine2$new_deaths_per_million[92:96] - preds2$)^2)
ASE2 #62.89
