...
fore.vacc_14 = forecast(Vacc_fit.ml_full, h = 14, xreg = c(Vacc_xreg_full,fore.mlp2.14.NV$mean))
plot(fore.vacc_14)

fore.vacc_40 = forecast(Vacc_fit.ml_full, h = 56)
plot(fore.vacc_40)
...
fit.mlp1 = mlp(ts(Post_Vaccine$new_deaths_per_million),reps = 50,comb = "median",xreg = Vacc_xreg_all)
fit.mlp1
plot(fit.mlp1)
