...
m1_fit = lm(Post_Vaccine$new_deaths_per_million~Post_Vaccine$new_cases_per_million+Post_Vaccine$new_vaccinations_smoothed_per_million+Post_Vaccine$hosp_patients_per_million+Post_Vaccine$icu_patients_per_million)
...
Pred_hs_6_m1 = fore.aruma.wge(Post_Vaccine$icu_patients_per_million, n.ahead = 6)
...
#get predictions
preds_m1_6 = predict(m1_fit,newxreg = next6_m1) #creates error because of factor
